...
/**
 * Created by maxiaowei on 2017/12/11.
 */
...
//    public static void showQrToast(Context context,String text,int yOffset){
//        TextView textView = new TextView(context);
//        textView.setTextColor(context.getResources().getColor(R.color.text_black));
//        textView.setText(text);
//        int dp5 = DensityUtil.dp2px(context,8);
//        int dp15 = DensityUtil.dp2px(context,20);
//        textView.setPadding(dp15,dp5,dp15,dp5);
//        textView.setBackgroundResource(R.drawable.shape_round_tip_qrcode);
//        Toast toast = new Toast(context);
//        toast.setDuration(Toast.LENGTH_SHORT);
//        toast.setView(textView);
//        toast.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.TOP,0,yOffset-dp15*4);
//        toast.show();
//    }
}
