...
public class RoundRectImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundRectImageView(Context context, AttributeSet attrs) {
        ...
        mType = ta.getInt(R.styleable.RoundRectImageView_type, DEFAULT_TYPE);
        mBorderColor = ta.getColor(R.styleable.RoundRectImageView_borderColor, DEFAULT_BORDER_COLOR);
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.RoundRectImageView_borderWidth, dip2px(DEFAULT_BORDER_WIDTH));
        mRectRoundRadius = ta.getDimensionPixelSize(R.styleable.RoundRectImageView_rectRoundRadius, dip2px(DEFAULT_RECT_ROUND_RADIUS));
        ta.recycle();
    }
