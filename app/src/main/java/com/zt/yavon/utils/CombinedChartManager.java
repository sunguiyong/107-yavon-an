...
public class CombinedChartManager {
    ...
    public CombinedChartManager(CombinedChart combinedChart) {
        ...
        color = ContextCompat.getColor(combinedChart.getContext(), R.color.white_tran);
    }
    ...
    private void initChart() {
        ...
        description.setTextColor(ContextCompat.getColor(mCombinedChart.getContext(),R.color.white_tran));
