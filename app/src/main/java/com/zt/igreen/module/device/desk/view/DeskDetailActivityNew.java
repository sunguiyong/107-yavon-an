package com.zt.igreen.module.device.desk.view;
...
import com.zt.igreen.module.device.desk.contract.DeskDetailContract;
import com.zt.igreen.module.device.desk.presenter.DeskDetailPresenter;
import com.zt.igreen.network.Api;
import com.zt.igreen.utils.DialogUtil;
import com.zt.igreen.widget.MyTextView;
import com.zt.igreen.widget.VerticalSeekBar;
...
public class DeskDetailActivityNew extends BaseActivity<DeskDetailPresenter> implements DeskDetailContract.View {
    public static final int WHAT_MAC = 0x35;
    public static final int HEIGHT_BOTTOM = 60;
    public static final int HEIGHT_TOP = 125;
    ...
    private LeakSafeHandler<DeskDetailActivityNew> mHandler = new LeakSafeHandler<DeskDetailActivityNew>(this) {
        @Override
        public void onMessageReceived(DeskDetailActivityNew activity, Message msg) {
...
//            LogUtil.d("===============收到frame:"+frame.toString());
    ...
    public int getLayoutId() {
        return R.layout.activity_desk_detail_new;
    }
...
//                mHandler.sendEmptyMessage(WHAT_SET);
    ...
    private void initSocket() {
        try {
            socket = new WebSocketFactory().createSocket(Api.HOST + ":5011/", 10000);
    ...
    public static void startAction(Context context, TabBean.MachineBean machineBean) {
        Intent intent = new Intent(context, DeskDetailActivityNew.class);
    ...
    @OnTouch({R.id.btn_up_desk, R.id.down_bt})
