        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapterView, View view, int position) {
                if(adapter.getItemViewType(position) == AllDevAdapter.TYPE_DETAIL){
                    ...
                    if (Constants.MACHINE_TYPE_AIR_MACHINE.equals(bean.getMachine_type())||Constants.MACHINE_TYPE_NFC_COASTER.equals(bean.getMachine_type())||Constants.MACHINE_TYPE_WATER_DISPENSER.equals(bean.getMachine_type())||Constants.MACHINE_TYPE_AIR_HEALTH.equals(bean.getMachine_type()))
                    {}else
